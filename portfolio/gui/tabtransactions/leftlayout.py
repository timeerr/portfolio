...
from portfolio.gui.tabtransactions.formquery import TransactionsQueryForm
from portfolio.gui.tabtransactions.addtransactionsform import AddTransactionsForm
