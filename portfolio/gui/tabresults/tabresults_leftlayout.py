...
from portfolio.gui.tabresults.tabresults_formquery import ResultsQueryForm
from portfolio.gui.tabresults.tabresults_addresultsform import AddResultsForm
