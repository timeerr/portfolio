...
def create_tables(path_to_db):
    ...
    transactions_table_query = """CREATE TABLE IF NOT EXISTS ctransactions(
    ...
    balances_table_query = """CREATE TABLE IF NOT EXISTS cbalances(
    ...
    balancehistory_table_query = """CREATE TABLE IF NOT EXISTS cbalancehistory(
        id integer PRIMARY KEY,
        account text NOT NULL,
        date timestamp NOT NULL,
        token text NOT NULL,
